...
*  final Completer<GoogleMapController> _controller = Completer();
  ...
  final CameraPosition _kGooglePlex = CameraPosition(target: LatLng(8.984744630984105, -79.51568584889174),
  zoom: 14);
  ...
  List<Marker> _list = [
    ...
    position: LatLng(8.984744630984105, -79.51568584889174),
    infoWindow: InfoWindow(
      title: "Custom marker info window"
    )
    )
  ];
